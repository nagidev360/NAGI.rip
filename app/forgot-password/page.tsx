...
export default function ForgotPassword() {
  return <main className="grid min-h-screen place-items-center bg-[#050507] px-6">
    <div className="glass w-full max-w-md rounded-3xl p-8">
      ...
      <p className="mt-2 text-sm text-white/50">We will send a secure reset link if the account exists.</p>
      <form className="mt-7 space-y-4" action="/api/auth/forgot" method="post">
        ...
        <button className="w-full rounded-2xl bg-white py-3 font-semibold text-black">Send reset link</button>
      </form>
